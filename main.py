...
nltk.data.path.append(r'C:/Users/Rivas_Gonzalez/AppData/Roaming/nltk_data')
...
texto = """
Mi nombre es Maria Cristina y soy de la ciudad de Bogota, pero vivo en la ciudad de Manizales, Colombia.
Soy Ingeniera de Alimentos pero me dedico a la asesoria en creditos de libranza en el Banco W.
Estoy casada con Juan Pablo y tenemos tres hijos: Juanes, Aleja e Isa.
Me encanta viajar, bailar y estar con mi familia.
"""
